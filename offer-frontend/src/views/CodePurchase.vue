<template>
    <div class="min-h-screen bg-gradient-to-br from-orange-100 to-amber-100 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div v-else class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="py-8 px-6 sm:px-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        <div v-for="product in products" :key="product.id" @click="selectProduct(product)" :class="[
