<template>
  <teleport to="body">
    <div class="fixed inset-0 z-50 flex items-center justify-center px-4 overflow-y-auto" style="z-index: 1000000;">
      <!-- 遮罩 -->
      ...
      <!-- 弹窗主体 -->
      <div
        class="relative bg-white rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-md mx-auto transform transition-all duration-300 ease-out my-8"
        ...
        <div>
          ...
          <div v-else>
            ...
            <div class="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
              <button v-for="(plan, idx) in plans" :key="plan.id" type="button" @click="selectedIndex = idx"
