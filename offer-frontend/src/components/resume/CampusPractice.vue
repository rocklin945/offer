            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button @click.stop.prevent="$emit('copy-to-clipboard', practice.startTime, '开始时间')"
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-2">
                        <input v-model="practice.endTime" type="text" placeholder="例如：2023.06"
                            class="input-field flex-1" />
                        <button @click.stop.prevent="$emit('copy-to-clipboard', practice.endTime, '结束时间')"
                            class="text-blue-600 hover:text-blue-800" type="button">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button @click.stop.prevent="$emit('copy-to-clipboard', practice.description, '实践描述')"
                            class="text-blue-600 hover:text-blue-800 self-start mt-1" type="button">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z">
                                </path>
