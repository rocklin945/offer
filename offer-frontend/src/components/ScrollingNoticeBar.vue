<template>
  <div v-if="visible" class="bg-gradient-to-r from-red-500 to-orange-500 text-white py-2 px-4 relative overflow-hidden">
    ...
    <button 
      @click="closeNotice" 
      class="absolute right-2 top-1/2 transform -translate-y-1/2 text-white hover:text-gray-200 focus:outline-none"
    >
